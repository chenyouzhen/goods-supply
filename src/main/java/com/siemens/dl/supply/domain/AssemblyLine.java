...
public class AssemblyLine implements Serializable {
    ...
    public AssemblyLine links(Set<Link> links) {
        this.links = links;
        return this;
    }

    public AssemblyLine addLink(Link link) {
        this.links.add(link);
        link.setAssemblyline(this);
        return this;
    }

    public AssemblyLine removeLink(Link link) {
        this.links.remove(link);
        link.setAssemblyline(null);
        return this;
    }
